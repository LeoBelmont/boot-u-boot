...
int VppOpenDispWin(int PlaneId, int WinX, int WinY, int WinW, int WinH, int BgClr, int Alpha,
		   int GlobalAlpha);
int VppChangeDispWin(int PlaneId, int WinX, int WinY, int WinW, int WinH, int BgClr, int Alpha,
		     int GlobalAlpha);
int VppChangeDispWinFromISR(int PlaneId, int WinX, int WinY, int WinW, int WinH, int BgClr,
			    int Alpha, int GlobalAlpha);
