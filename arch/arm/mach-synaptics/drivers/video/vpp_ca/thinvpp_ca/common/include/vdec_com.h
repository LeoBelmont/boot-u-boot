...
#define MAX_NUM_DISTRIBUTIONS 9
#define MAX_NUM_BEZIER_CURVE_ANCHORS 9
...
typedef struct vbuf_info_hdr10plus_meta_t
{
    UINT8   application_ver;
    UINT8   targeted_sys_dis_max_lum;
    UINT8   avg_maxrgb;
    UINT8   distribution_values[MAX_NUM_DISTRIBUTIONS];
    UINT16  knee_point_x;
    UINT16  knee_point_y;
    UINT8   num_bezier_curve_anchors;
    UINT8   bezier_curve_anchors[MAX_NUM_BEZIER_CURVE_ANCHORS];
    UINT8   gph_ovl_flag;
    UINT8   vsif_timing_mode;
}HDR10PLUS_META_INFO;
...
typedef struct MTR_BUFF_DESC_t
{
    ...
    UINT32 m_MmuCfgPbm_weave;

    UINT8  m_MmuCfgVm_enable;
    UINT8  m_MmuCfgVm_mode;
}MTR_BUFF_DESC;
...
typedef struct vbuf_info_t
{
    ...
    **/
    ...
    //For HDR10+
    UINT32 m_hdr10plus_present_mode;
    HDR10PLUS_META_INFO m_hdr10plus_meta;
    ...
    /** MMU INFO of Y and UV. **/
    BOOL is_uv_buf_allocated;
    UINT8 m_buf_src;
