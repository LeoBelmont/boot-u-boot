...
#define	MV_BYTE_SWAP_64BIT(X) ((MV_U64) (						\
...
#define GA_REG_WORD32_READ(addr, holder) \
	(*(holder) = ((*((volatile unsigned int *)(uintptr_t)(addr)))))
#define GA_REG_WORD32_WRITE(addr, data) \
	((*((volatile unsigned int *)(uintptr_t)(addr))) = ((unsigned int)(data)))
