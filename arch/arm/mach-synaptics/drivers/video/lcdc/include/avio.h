...
#define h_oneReg () {}
	...
	SIGN32 oneReg_cmp(SIE_oneReg *p, SIE_oneReg *pie, char *pfx, void *hLOG, SIGN32 mem,
			  SIGN32 tst);
...
#define h_AVIO_REG () {}
	...
	SIGN32 AVIO_REG_cmp(SIE_AVIO_REG *p, SIE_AVIO_REG *pie, char *pfx, void *hLOG,
...
#define h_OCCURENCE () {}
	...
	SIGN32 OCCURENCE_drvwr(SIE_OCCURENCE *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
			       UNSG32 *pcmd);
	void OCCURENCE_reset(SIE_OCCURENCE *p);
	SIGN32 OCCURENCE_cmp(SIE_OCCURENCE *p, SIE_OCCURENCE *pie, char *pfx, void *hLOG,
			     SIGN32 mem, SIGN32 tst);
