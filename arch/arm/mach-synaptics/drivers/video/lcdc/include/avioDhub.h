...
#define h_SemaINTR () {}
	...
	SIGN32 SemaINTR_cmp(SIE_SemaINTR *p, SIE_SemaINTR *pie, char *pfx, void *hLOG,
...
#define h_Semaphore () {}
	...
	SIGN32 Semaphore_drvwr(SIE_Semaphore *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
			       UNSG32 *pcmd);
	void Semaphore_reset(SIE_Semaphore *p);
	SIGN32 Semaphore_cmp(SIE_Semaphore *p, SIE_Semaphore *pie, char *pfx, void *hLOG,
			     SIGN32 mem, SIGN32 tst);
...
#define h_SemaQuery () {}
	...
	SIGN32 SemaQuery_cmp(SIE_SemaQuery *p, SIE_SemaQuery *pie, char *pfx, void *hLOG,
			     SIGN32 mem, SIGN32 tst);
...
#define h_SemaQueryMap () {}
	...
	SIGN32 SemaQueryMap_drvwr(SIE_SemaQueryMap *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
				  UNSG32 *pcmd);
	void SemaQueryMap_reset(SIE_SemaQueryMap *p);
	SIGN32 SemaQueryMap_cmp(SIE_SemaQueryMap *p, SIE_SemaQueryMap *pie, char *pfx,
				void *hLOG, SIGN32 mem, SIGN32 tst);
	#define SemaQueryMap_check(p, pie, pfx, hLOG) \
		SemaQueryMap_cmp(p, pie, pfx, (void *)(hLOG), 0, 0)
	#define SemaQueryMap_print(p,    pfx, hLOG) \
		SemaQueryMap_cmp(p, 0,  pfx, (void *)(hLOG), 0, 0)
...
#define h_SemaHub () {}
	...
	SIGN32 SemaHub_cmp(SIE_SemaHub *p, SIE_SemaHub *pie, char *pfx, void *hLOG, SIGN32 mem,
			   SIGN32 tst);
...
#define h_FiFo () {}
	...
	SIGN32 FiFo_cmp(SIE_FiFo *p, SIE_FiFo *pie, char *pfx, void *hLOG, SIGN32 mem,
			SIGN32 tst);
...
#define h_LLDesFmt () {}
	...
	SIGN32 LLDesFmt_cmp(SIE_LLDesFmt *p, SIE_LLDesFmt *pie, char *pfx, void *hLOG,
			    SIGN32 mem, SIGN32 tst);
...
#define h_dHubCmdHDR () {}
	...
	SIGN32 dHubCmdHDR_drvwr(SIE_dHubCmdHDR *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
				UNSG32 *pcmd);
	void dHubCmdHDR_reset(SIE_dHubCmdHDR *p);
	SIGN32 dHubCmdHDR_cmp(SIE_dHubCmdHDR *p, SIE_dHubCmdHDR *pie, char *pfx, void *hLOG,
			      SIGN32 mem, SIGN32 tst);
...
#define h_dHubCmd () {}
	...
	SIGN32 dHubCmd_cmp(SIE_dHubCmd *p, SIE_dHubCmd *pie, char *pfx, void *hLOG, SIGN32 mem,
			   SIGN32 tst);
...
#define h_dHubChannel () {}
	...
	SIGN32 dHubChannel_drvwr(SIE_dHubChannel *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
				 UNSG32 *pcmd);
	void dHubChannel_reset(SIE_dHubChannel *p);
	SIGN32 dHubChannel_cmp(SIE_dHubChannel *p, SIE_dHubChannel *pie, char *pfx, void *hLOG,
			       SIGN32 mem, SIGN32 tst);
...
#define h_dHubReg () {}
	...
	SIGN32 dHubReg_cmp(SIE_dHubReg *p, SIE_dHubReg *pie, char *pfx, void *hLOG, SIGN32 mem,
			   SIGN32 tst);
...
#define h_dHubCmd2D () {}
	...
	SIGN32 dHubCmd2D_drvwr(SIE_dHubCmd2D *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
			       UNSG32 *pcmd);
	void dHubCmd2D_reset(SIE_dHubCmd2D *p);
	SIGN32 dHubCmd2D_cmp(SIE_dHubCmd2D *p, SIE_dHubCmd2D *pie, char *pfx, void *hLOG,
			     SIGN32 mem, SIGN32 tst);
...
#define h_dHubCmd2ND () {}
	...
	SIGN32 dHubCmd2ND_drvwr(SIE_dHubCmd2ND *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
				UNSG32 *pcmd);
	void dHubCmd2ND_reset(SIE_dHubCmd2ND *p);
	SIGN32 dHubCmd2ND_cmp(SIE_dHubCmd2ND *p, SIE_dHubCmd2ND *pie, char *pfx, void *hLOG,
			      SIGN32 mem, SIGN32 tst);
...
#define h_dHubQuery () {}
	...
	SIGN32 dHubQuery_drvwr(SIE_dHubQuery *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
			       UNSG32 *pcmd);
	void dHubQuery_reset(SIE_dHubQuery *p);
	SIGN32 dHubQuery_cmp(SIE_dHubQuery *p, SIE_dHubQuery *pie, char *pfx, void *hLOG,
			     SIGN32 mem, SIGN32 tst);
...
#define h_dHubReg2D () {}
	...
	SIGN32 dHubReg2D_drvwr(SIE_dHubReg2D *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
			       UNSG32 *pcmd);
	void dHubReg2D_reset(SIE_dHubReg2D *p);
	SIGN32 dHubReg2D_cmp(SIE_dHubReg2D *p, SIE_dHubReg2D *pie, char *pfx, void *hLOG,
			     SIGN32 mem, SIGN32 tst);
...
#define h_avioDhubChMap () {}
	...
	SIGN32 avioDhubChMap_drvwr(SIE_avioDhubChMap *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
				   UNSG32 *pcmd);
	void avioDhubChMap_reset(SIE_avioDhubChMap *p);
	SIGN32 avioDhubChMap_cmp(SIE_avioDhubChMap *p, SIE_avioDhubChMap *pie, char *pfx,
				 void *hLOG, SIGN32 mem, SIGN32 tst);
	#define avioDhubChMap_check(p, pie, pfx, hLOG) \
		avioDhubChMap_cmp(p, pie, pfx, (void *)(hLOG), 0, 0)
	#define avioDhubChMap_print(p,    pfx, hLOG) \
		avioDhubChMap_cmp(p, 0,  pfx, (void *)(hLOG), 0, 0)
...
#define h_avioDhubTcmMap () {}
	...
	SIGN32 avioDhubTcmMap_drvwr(SIE_avioDhubTcmMap *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
				    UNSG32 *pcmd);
	void avioDhubTcmMap_reset(SIE_avioDhubTcmMap *p);
	SIGN32 avioDhubTcmMap_cmp(SIE_avioDhubTcmMap *p, SIE_avioDhubTcmMap *pie, char *pfx,
				  void *hLOG, SIGN32 mem, SIGN32 tst);
	#define avioDhubTcmMap_check(p, pie, pfx, hLOG) \
		avioDhubTcmMap_cmp(p, pie, pfx, (void *)(hLOG), 0, 0)
	#define avioDhubTcmMap_print(p,    pfx, hLOG) \
		avioDhubTcmMap_cmp(p, 0,  pfx, (void *)(hLOG), 0, 0)
...
#define h_avioDhubSemMap () {}
	...
	SIGN32 avioDhubSemMap_drvwr(SIE_avioDhubSemMap *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
				    UNSG32 *pcmd);
	void avioDhubSemMap_reset(SIE_avioDhubSemMap *p);
	SIGN32 avioDhubSemMap_cmp(SIE_avioDhubSemMap *p, SIE_avioDhubSemMap *pie, char *pfx,
				  void *hLOG, SIGN32 mem, SIGN32 tst);
	#define avioDhubSemMap_check(p, pie, pfx, hLOG) \
		avioDhubSemMap_cmp(p, pie, pfx, (void *)(hLOG), 0, 0)
	#define avioDhubSemMap_print(p,    pfx, hLOG) \
		avioDhubSemMap_cmp(p, 0,  pfx, (void *)(hLOG), 0, 0)
...
#define h_vppTcmEntry () {}
	...
	SIGN32 vppTcmEntry_drvwr(SIE_vppTcmEntry *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
				 UNSG32 *pcmd);
	void vppTcmEntry_reset(SIE_vppTcmEntry *p);
	SIGN32 vppTcmEntry_cmp(SIE_vppTcmEntry *p, SIE_vppTcmEntry *pie, char *pfx, void *hLOG,
			       SIGN32 mem, SIGN32 tst);
...
#define h_vpp128bDhub () {}
	...
	SIGN32 vpp128bDhub_drvwr(SIE_vpp128bDhub *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
				 UNSG32 *pcmd);
	void vpp128bDhub_reset(SIE_vpp128bDhub *p);
	SIGN32 vpp128bDhub_cmp(SIE_vpp128bDhub *p, SIE_vpp128bDhub *pie, char *pfx, void *hLOG,
			       SIGN32 mem, SIGN32 tst);
...
#define h_aio64bDhub () {}
	...
	SIGN32 aio64bDhub_drvwr(SIE_aio64bDhub *p, UNSG32 base, SIGN32 mem, SIGN32 tst,
				UNSG32 *pcmd);
	void aio64bDhub_reset(SIE_aio64bDhub *p);
	SIGN32 aio64bDhub_cmp(SIE_aio64bDhub *p, SIE_aio64bDhub *pie, char *pfx, void *hLOG,
			      SIGN32 mem, SIGN32 tst);
	#define aio64bDhub_check(p, pie, pfx, hLOG) \
		aio64bDhub_cmp(p, pie, pfx, (void *)(hLOG), 0, 0)
	#define aio64bDhub_print(p, pfx, hLOG) \
		aio64bDhub_cmp(p, 0,   pfx, (void *)(hLOG), 0, 0)
