...
#define h_BITMAP32 () {}
	...
	SIGN32 BITMAP32_cmp(SIE_BITMAP32 *p, SIE_BITMAP32 *pie, char *pfx, void *hLOG, SIGN32 mem,
			    SIGN32 tst);
...
#define h_LCDC_REG () {}
	...
	SIGN32 LCDC_REG_cmp(SIE_LCDC_REG *p, SIE_LCDC_REG *pie, char *pfx, void *hLOG, SIGN32 mem,
			    SIGN32 tst);
