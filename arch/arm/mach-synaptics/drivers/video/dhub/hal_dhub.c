...
void dhub2d_channel_clear_seq(void *hdl, SIGN32 id)
{
	...
	dhub2d_channel_clear_done((HDL_dhub2d *)hdl, id);
	...
	hbo_queue_clear_done(dhub_hbo(&((HDL_dhub2d *)hdl)->dhub), cmdID);

	hbo_queue_enable(dhub_hbo(&((HDL_dhub2d *)hdl)->dhub), dataID, 0, NULL);
	hbo_queue_clear(dhub_hbo(&((HDL_dhub2d *)hdl)->dhub), dataID);
	hbo_queue_clear_done(dhub_hbo(&((HDL_dhub2d *)hdl)->dhub), dataID);
}
...
void dhub2nd_channel_clear_seq(void *hdl, SIGN32 id)
{
	...
	dhub2nd_channel_clear((HDL_dhub2d *)hdl, id);
	dhub2d_channel_clear_done((HDL_dhub2d *)hdl, id);
 ...
 ****************************************************/
void dhub2d_channel_clear_seq_bcm(void *hdl, SIGN32 id, BCMBUF *pbcmbuf)
{
	UNSG32 cmdID = dhub_id2hbo_cmdQ(id), dataID = dhub_id2hbo_data(id);
 ...
 *  No wait, return immediately. Use BCM buffer.
 ****************************************************/
void dhub_channel_clear_seq(void *hdl, SIGN32 id, BCMBUF *pbcmbuf)
{
	UNSG32 cmdID = dhub_id2hbo_cmdQ(id), dataID = dhub_id2hbo_data(id);
 ...
 *  No wait, return immediately. Use BCM buffer.
 ****************************************************/
void dhub2nd_channel_clear_seq_bcm(void *hdl, SIGN32 id, BCMBUF *pbcmbuf)
{
	UNSG32 cmdID = dhub_id2hbo_cmdQ(id), dataID = dhub_id2hbo_data(id);
